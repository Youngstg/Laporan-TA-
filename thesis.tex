...
\addbibresource{references.bib} % Import list Daftar Pustaka untuk biblatex

% Menambah margin antara kotak (\fbox) dan gambar di dalamnya secara global
\setlength{\fboxsep}{12pt}

% Merapikan tabel dengan menambah padding vertikal pada semua tabel di dokumen
...
\begin{document}
    ...
    \title{Analisis Model VideoMAE untuk Klasifikasi Gerakan Bahasa Isyarat SIBI Berbasis Video}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Analysis of VideoMAE Model for Video-Based SIBI Sign Language Gesture Classification}
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    
    % Informasi Mahasiswa
	\author{Lucky Immanuel Sitanggang}		% Nama Mahasiswa
	\nim{122140179}				% NIM Mahasiswa
	
	%Informasi Dosen Pembimbing
	\dosbingA%
		{I Wayan Wiprayoga Wisesa, S.Kom., M.Kom.}%			% Nama Dosen Pembimbing 1
		{NIP. 19890322 201903 1 009}	% NIP Dosen Pembimbing 1
		
	%Informasi Dosen Penguji
	\pengujiA%
		{Radhinka Bagaskara, S.Si.Kom., M.Si., M.Sc.}%				% Nama Dosen Penguji 1
		{NIP. 19941127 202012 1 018}	% NIP Dosen Penguji 1
	\pengujiB%
		{Hartanto Tantriawan, S.Kom., M.Kom.}%				% Nama Dosen Penguji 2
		{NIP. 19920522 201903 1 012}	% NIP Dosen Penguji 2
	...
	\pagebreak
	\input{chapters/symbols} 		% Daftar Simbol
	% Daftar kode
	\phantomsection% 
