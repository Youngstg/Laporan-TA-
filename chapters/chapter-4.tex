...
\begin{figure}[H]
  \centering
  \makebox[\linewidth][c]{\fbox{\begin{minipage}{0.90\linewidth}
  \centering
...
Bagian ini menyajikan hasil evaluasi model VideoMAE dalam mengklasifikasikan gerakan visual Bahasa Isyarat SIBI. Keseluruhan eksperimen menggunakan skema 5-Fold Cross Validation sebagaimana telah dirancang pada Bab III, sehingga setiap nilai akurasi yang dilaporkan merupakan rata-rata dari kelima lipatan kecuali disebutkan lain. Setiap learning curve yang disajikan terdiri atas grafik accuracy (kiri) dan loss (kanan). Terdapat enam kelompok eksperimen yang dianalisis: (1) perbandingan konfigurasi backbone dan dataset pre-train, (2) perbandingan strategi pelatihan pre-train dan scratch, (3) perbandingan strategi sampling frame, (4) analisis pengaruh jumlah epoch, (5) pengaruh augmentasi mixup, CutMix, dan reprob terhadap performa model, serta (6) perbandingan lintas arsitektur antara VideoMAE, ViViT, dan model baseline I3D. Setiap kelompok eksperimen diberi kode E1, E2, dan seterusnya untuk memudahkan rujukan.
%===========================================================================
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2.png}}}
...
\hline
\rowcolor{gray!15} \multicolumn{1}{|c|}{} & \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E1 (ViT-S + K400)}} & \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E2 (ViT-B + K400)}} & \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E3 (ViT-S + SSV2)}} & \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E4 (ViT-B + SSV2)}} \\
\cline{2-13}
\rowcolor{gray!15} \multicolumn{1}{|c|}{\multirow{-2}{*}{\textbf{Kelas}}} & \multicolumn{1}{c|}{$P$} & \multicolumn{1}{c|}{$R$} & \multicolumn{1}{c|}{$F_1$} & \multicolumn{1}{c|}{$P$} & \multicolumn{1}{c|}{$R$} & \multicolumn{1}{c|}{$F_1$} & \multicolumn{1}{c|}{$P$} & \multicolumn{1}{c|}{$R$} & \multicolumn{1}{c|}{$F_1$} & \multicolumn{1}{c|}{$P$} & \multicolumn{1}{c|}{$R$} & \multicolumn{1}{c|}{$F_1$} \\
\hline
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vits_ssv2_new_font.png}}}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_twostage.png}}}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_twostage_scratch.png}}}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_singlestage_scratch.png}}}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vits_ssv2_twostage_new_font.png}}}
...
{\setlength{\tabcolsep}{3pt}
\footnotesize
\begin{tabular}{|l|>{\raggedright\arraybackslash}p{1.9cm}|>{\raggedright\arraybackslash}p{1.9cm}|>{\raggedright\arraybackslash}p{1.9cm}|}
\hline
\rowcolor{gray!15} \multicolumn{1}{|c|}{\textbf{Parameter}} & \multicolumn{1}{>{\centering\arraybackslash}p{1.9cm}|}{\textbf{E8}} & \multicolumn{1}{>{\centering\arraybackslash}p{1.9cm}|}{\textbf{E5}} & \multicolumn{1}{>{\centering\arraybackslash}p{1.9cm}|}{\textbf{E9}} \\
\hline
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_twostage_10ep.png}}}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_twostage_stage2_100ep.png}}}
...
{\setlength{\tabcolsep}{3pt}
\footnotesize
\begin{tabular}{|l|>{\centering\arraybackslash}p{0.6cm}|>{\centering\arraybackslash}p{0.6cm}|>{\centering\arraybackslash}p{0.6cm}|>{\centering\arraybackslash}p{0.6cm}|>{\centering\arraybackslash}p{0.6cm}|>{\centering\arraybackslash}p{0.6cm}|>{\centering\arraybackslash}p{0.6cm}|>{\centering\arraybackslash}p{0.6cm}|>{\centering\arraybackslash}p{0.6cm}|}
\hline
\rowcolor{gray!15} \multicolumn{1}{|c|}{} & \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E8 (10 epoch)}} & \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E5 (50 epoch)}} & \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E9 (100 epoch)}} \\
\cline{2-10}
\rowcolor{gray!15} \multicolumn{1}{|c|}{\multirow{-2}{*}{\textbf{Kelas}}} & \multicolumn{1}{c|}{$P$} & \multicolumn{1}{c|}{$R$} & \multicolumn{1}{c|}{$F_1$} & \multicolumn{1}{c|}{$P$} & \multicolumn{1}{c|}{$R$} & \multicolumn{1}{c|}{$F_1$} & \multicolumn{1}{c|}{$P$} & \multicolumn{1}{c|}{$R$} & \multicolumn{1}{c|}{$F_1$} \\
\hline
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vits_ssv2_twostage_stage2_100ep_new_font.png}}}
...
{\setlength{\tabcolsep}{3pt}
\footnotesize
\begin{tabular}{|l|>{\raggedright\arraybackslash}p{1.9cm}|>{\raggedright\arraybackslash}p{1.9cm}|}
\hline
\rowcolor{gray!15} \multicolumn{1}{|c|}{\textbf{Parameter}} & \multicolumn{1}{>{\centering\arraybackslash}p{1.9cm}|}{\textbf{E5}} & \multicolumn{1}{>{\centering\arraybackslash}p{1.9cm}|}{\textbf{E10}} \\
\hline
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_dense.png}}}
...
\hline
\rowcolor{gray!15} \multicolumn{1}{|c|}{} & \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E5 (\textit{Uniform Sampling})}} & \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E10 (\textit{Dense Sampling})}} \\
\cline{2-7}
\rowcolor{gray!15} \multicolumn{1}{|c|}{\multirow{-2}{*}{\textbf{Kelas}}} & \multicolumn{1}{c|}{$P$} & \multicolumn{1}{c|}{$R$} & \multicolumn{1}{c|}{$F_1$} & \multicolumn{1}{c|}{$P$} & \multicolumn{1}{c|}{$R$} & \multicolumn{1}{c|}{$F_1$} \\
\hline
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vits_ssv2_dense_new_font.png}}}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_uniform_nomixup.png}}}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\fbox{\begin{minipage}{0.65\linewidth}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vitb_k400_dense_nomixup.png}}}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vivit.png}}}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_i3d.png}}}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vitb_k400_dense_nomixup_new_font.png}}}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vivit_new_font.png}}}
...
\begin{figure}[H]
\centering
{\setlength{\fboxsep}{0pt}\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_i3d_new_font.png}}}
...
\hline
\rowcolor{gray!15} \multicolumn{1}{|c|}{\textbf{Kode}} & \multicolumn{1}{>{\centering\arraybackslash}p{2.5cm}|}{\makecell[c]{\textbf{Kelompok}\\\textbf{Eksperimen}}} & \multicolumn{1}{>{\centering\arraybackslash}X|}{\textbf{Konfigurasi}} & \multicolumn{1}{>{\centering\arraybackslash}p{2.3cm}|}{\makecell[c]{\textbf{Rerata} $\pm$ \textbf{Std}\\\textbf{(\%)}}} & \multicolumn{1}{>{\centering\arraybackslash}p{1.3cm}|}{\makecell[c]{\textbf{Acc@1}\\\textbf{(\%)}}} \\
\hline
...
\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\fbox{\begin{minipage}{0.90\textwidth}
\centering
% Row 1: Mau
