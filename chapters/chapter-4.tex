...
\hline
No & Kelas & Jumlah Klip & No & Kelas & Jumlah Klip \\
\hline
1  & Aku     & 90  & 6  & Kamu    & 93 \\
\hline
2  & Bapak   & 90  & 7  & Mau     & 99 \\
...
\hline
\multicolumn{1}{|c|}{\textbf{Parameter}} & \multicolumn{1}{c|}{\textbf{E1}} & \multicolumn{1}{c|}{\textbf{E2}} & \multicolumn{1}{c|}{\textbf{E3}} & \multicolumn{1}{c|}{\textbf{E4}} \\
\hline
\textit{Backbone} & ViT-Small & ViT-Base & ViT-Small & ViT-Base \\
\hline
Dataset \textit{Pre-train} & Kinetics-400 & Kinetics-400 & SSV2 & SSV2 \\
\hline
Strategi Pelatihan & \multicolumn{4}{c|}{\textit{Fine-tune} 1-tahap} \\
\hline
\textit{Epoch} & \multicolumn{4}{c|}{50} \\
\hline
\textit{Batch Size} & \multicolumn{4}{c|}{16} \\
\hline
\textit{Learning Rate} & \multicolumn{4}{c|}{$10^{-3}$} \\
\hline
\textit{Hyperparameter} Lain & \multicolumn{4}{c|}{Sama dengan Tabel~\ref{tab:4.umum_config}} \\
\hline
\end{tabular}
\end{table}
...
\hline
Kode & \multicolumn{1}{c|}{Fold 1} & \multicolumn{1}{c|}{Fold 2} & \multicolumn{1}{c|}{Fold 3} & \multicolumn{1}{c|}{Fold 4} & \multicolumn{1}{c|}{Fold 5} & \multicolumn{1}{c|}{\makecell[c]{Rata-\\rata}} & \multicolumn{1}{c|}{Terbaik} \\
\hline
...
\hline
Kode & \textit{Backbone} & \textit{Pre-train} & \makecell[c]{Rata-rata\\Acc (\%)} & \makecell[c]{\textit{Macro}\\F1 (\%)} & MAE \\
\hline
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2.png}}
...
\hline
\multirow{2}{*}{Kelas} &
  \multicolumn{3}{c|}{E1 (ViT-S + K400)} &
  \multicolumn{3}{c|}{E2 (ViT-B + K400)} &
  \multicolumn{3}{c|}{E3 (ViT-S + SSV2)} &
  \multicolumn{3}{c|}{E4 (ViT-B + SSV2)} \\
\cline{2-13}
 & \multicolumn{1}{c|}{P} & \multicolumn{1}{c|}{R} & \multicolumn{1}{c|}{F1} & \multicolumn{1}{c|}{P} & \multicolumn{1}{c|}{R} & \multicolumn{1}{c|}{F1} & \multicolumn{1}{c|}{P} & \multicolumn{1}{c|}{R} & \multicolumn{1}{c|}{F1} & \multicolumn{1}{c|}{P} & \multicolumn{1}{c|}{R} & \multicolumn{1}{c|}{F1} \\
\hline
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vits_ssv2_new_font.png}}
...
\hline
\multicolumn{1}{|c|}{\textbf{Parameter}} & \multicolumn{1}{c|}{\textbf{E5}} & \multicolumn{1}{c|}{\textbf{E6}} & \multicolumn{1}{c|}{\textbf{E7}} \\
\hline
Strategi Pelatihan & \makecell[c]{\textit{Two-Stage}\\\textit{Pre-train}} & \makecell[c]{\textit{Two-Stage}\\\textit{Scratch}} & \makecell[c]{\textit{Single-Stage}\\\textit{Scratch}} \\
\hline
Inisialisasi & Bobot SSV2 & Acak & Acak \\
\hline
\textit{Epoch Stage} 1 & 5 & 5 & {--} \\
\hline
\textit{Epoch Stage} 2 & \multicolumn{3}{c|}{50} \\
\hline
\textit{Learning Rate Stage} 1 & $10^{-3}$ & $10^{-3}$ & {--} \\
\hline
\textit{Learning Rate Stage} 2 & $10^{-5}$ & $10^{-5}$ & $10^{-3}$ \\
\hline
\textit{Batch Size} & \multicolumn{3}{c|}{16} \\
\hline
\textit{Hyperparameter} Lain & \multicolumn{3}{c|}{Sama dengan Tabel~\ref{tab:4.umum_config}} \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_twostage.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_twostage_scratch.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_singlestage_scratch.png}}
...
\begin{tabular}{|l|r|r|r|r|}
\hline
Kelas & \multicolumn{1}{c|}{Presisi} & \multicolumn{1}{c|}{\textit{Recall}} & \multicolumn{1}{c|}{F1-\textit{Score}} & \multicolumn{1}{c|}{\textit{Support}} \\
\hline
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vits_ssv2_twostage_new_font.png}}
...
\begin{tabular}{|l|c|c|c|}
\hline
\multicolumn{1}{|c|}{\textbf{Parameter}} & \makecell[c]{\hspace{0.8cm}\textbf{E8}\hspace{0.8cm}} & \makecell[c]{\hspace{0.8cm}\textbf{E5}\hspace{0.8cm}} & \makecell[c]{\hspace{0.8cm}\textbf{E9}\hspace{0.8cm}} \\
\hline
Strategi Pelatihan & \multicolumn{3}{c|}{\textit{Two-Stage Pre-train}} \\
\hline
Inisialisasi & \multicolumn{3}{c|}{Bobot SSV2} \\
\hline
\textit{Epoch Stage} 1 & \multicolumn{3}{c|}{5} \\
\hline
\textit{Epoch Stage} 2 & 10 & 50 & 100 \\
\hline
\textit{Learning Rate Stage} 1 & \multicolumn{3}{c|}{$10^{-3}$} \\
\hline
\textit{Learning Rate Stage} 2 & \multicolumn{3}{c|}{$10^{-5}$} \\
\hline
\textit{Batch Size} & \multicolumn{3}{c|}{16} \\
\hline
\textit{Hyperparameter} Lain & \multicolumn{3}{c|}{Sama dengan Tabel~\ref{tab:4.umum_config}} \\
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_twostage_10ep.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_twostage_stage2_100ep.png}}
...
\hline
\multirow{2}{*}{Kelas} &
  \multicolumn{3}{c|}{E8 (10 epoch)} &
  \multicolumn{3}{c|}{E5 (50 epoch)} &
  \multicolumn{3}{c|}{E9 (100 epoch)} \\
\cline{2-10}
 & \multicolumn{1}{c|}{P} & \multicolumn{1}{c|}{R} & \multicolumn{1}{c|}{F1} & \multicolumn{1}{c|}{P} & \multicolumn{1}{c|}{R} & \multicolumn{1}{c|}{F1} & \multicolumn{1}{c|}{P} & \multicolumn{1}{c|}{R} & \multicolumn{1}{c|}{F1} \\
\hline
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vits_ssv2_twostage_stage2_100ep_new_font.png}}
...
\begin{tabular}{|l|c|c|}
\hline
\multicolumn{1}{|c|}{\textbf{Parameter}} & \multicolumn{1}{c|}{\textbf{E5}} & \multicolumn{1}{c|}{\textbf{E10}} \\
\hline
Strategi \textit{Sampling} & \textit{Uniform} & \textit{Dense} \\
\hline
\textit{Epoch Stage} 1 & \multicolumn{2}{c|}{5} \\
\hline
\textit{Epoch Stage} 2 & \multicolumn{2}{c|}{50} \\
\hline
Jumlah \textit{Frame} & \multicolumn{2}{c|}{16} \\
\hline
\textit{Batch Size} & \multicolumn{2}{c|}{16} \\
\hline
\textit{Learning Rate} & \multicolumn{2}{c|}{$10^{-3}$} \\
\hline
\textit{Hyperparameter} Lain & \multicolumn{2}{c|}{Sama dengan Tabel~\ref{tab:4.umum_config}} \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_dense.png}}
...
\hline
\multirow{2}{*}{Kelas} &
  \multicolumn{3}{c|}{E5 (\textit{Uniform Sampling})} &
  \multicolumn{3}{c|}{E10 (\textit{Dense Sampling})} \\
\cline{2-7}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vits_ssv2_dense_new_font.png}}
...
\begin{tabular}{|l|c|c|}
\hline
\multicolumn{1}{|c|}{\textbf{Parameter}} & \multicolumn{1}{c|}{\textbf{E5}} & \multicolumn{1}{c|}{\textbf{E11}} \\
\hline
\textit{Backbone} & \multicolumn{2}{c|}{ViT-Small} \\
\hline
Dataset \textit{Pre-train} & \multicolumn{2}{c|}{SSV2} \\
\hline
Strategi \textit{Sampling} & \multicolumn{2}{c|}{\textit{Uniform}} \\
\hline
\makecell[l]{Augmentasi\\(\textit{Mixup, CutMix, Reprob})} & Aktif & Dinonaktifkan \\
\hline
\textit{Epoch} (\textit{Stage} 1 / \textit{Stage} 2) & \multicolumn{2}{c|}{5 / 50} \\
\hline
\textit{Batch Size} & \multicolumn{2}{c|}{16} \\
\hline
\textit{Learning Rate} & \multicolumn{2}{c|}{$10^{-3}$} \\
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vits_ssv2_uniform_nomixup.png}}
...
\begin{subfigure}[t]{0.47\textwidth}
  \centering
  \fbox{\includegraphics[width=\linewidth]{figure/aug_mixup_asli.png}}
  \caption{Asli: gestur \textit{Aku}}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.47\textwidth}
  \centering
  \fbox{\includegraphics[width=\linewidth]{figure/aug_mixup_hasil.png}}
...
\begin{subfigure}[t]{0.47\textwidth}
  \centering
  \fbox{\includegraphics[width=\linewidth]{figure/aug_cutmix_asli.png}}
  \caption{Asli: gestur \textit{Aku}}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.47\textwidth}
  \centering
  \fbox{\includegraphics[width=\linewidth]{figure/aug_cutmix_hasil.png}}
...
\begin{subfigure}[t]{0.47\textwidth}
  \centering
  \fbox{\includegraphics[width=\linewidth]{figure/aug_erase_asli.png}}
  \caption{Asli: gestur \textit{Aku}}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.47\textwidth}
  \centering
  \fbox{\includegraphics[width=\linewidth]{figure/aug_erase_hasil.png}}
...
\begin{tabular}{|l|r|r|r|r|}
\hline
\multicolumn{1}{|c|}{\textbf{Parameter}} & \multicolumn{1}{c|}{\textbf{E11}} & \multicolumn{1}{c|}{\textbf{E12}} & \multicolumn{1}{c|}{\textbf{ViViT}} & \multicolumn{1}{c|}{\textbf{I3D}} \\
\hline
\makecell[l]{Arsitektur\\Model} & \makecell[c]{VideoMAE\\ViT-Small} & \makecell[c]{VideoMAE\\ViT-Base} & ViViT-B/16x2 & \makecell[c]{I3D (Inflated\\3D ConvNet)} \\
\hline
\makecell[l]{Dataset\\\textit{Pre-train}} & SSV2 & Kinetics-400 & Kinetics-400 & ImageNet \\
\hline
\makecell[l]{Strategi\\\textit{Sampling}} & \makecell[c]{\textit{Uniform}\\(SSV2 loader)} & \makecell[c]{\textit{Dense}\\(Kin. loader)} & Seragam & \makecell[c]{Seluruh video\\(RGB)} \\
\hline
\makecell[l]{\textit{Epoch}\\Total} & 55 (5 + 50) & 55 (5 + 50) & 55 & 55 \\
\hline
\makecell[l]{Jumlah\\\textit{Frame}} & 16 & 16 & 32 & 64 \\
\hline
\makecell[l]{\textit{Learning}\\Rate} & \multicolumn{4}{c|}{$10^{-3}$} \\
\hline
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vitb_k400_dense_nomixup.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_vivit.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/lc_i3d.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vitb_k400_dense_nomixup_new_font.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_vivit_new_font.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{figure/cm_i3d_new_font.png}}
...
\begin{tabular}{|l|c|c|c|}
\hline
Model & \makecell[c]{Library\\Dekode Video} & Frame & Normalisasi \\
\hline
...
\begin{tabular}{|l|c|c|c|}
\hline
Model & Param. & \makecell[c]{Frame\\Input} & \makecell[c]{Rata-rata\\(ms)} \\
\hline
...
\hline
\rowcolor{gray!20} \multicolumn{1}{|c|}{Kode} & \multicolumn{1}{c|}{\makecell[c]{Kelompok\\Eksperimen}} & \multicolumn{1}{c|}{Konfigurasi} & \multicolumn{1}{c|}{\makecell[c]{Rerata $\pm$ Std\\(\%)}} & \multicolumn{1}{c|}{\makecell[c]{Acc@1\\(\%)}} \\
\hline
