...
\begin{align*}
  0.044715 \times (0.921)^3 &= 0.044715 \times 0.782 = 0.035 \\
  \sqrt{2/\pi} \times (0.921 + 0.035) &= 0.7979 \times 0.956 = 0.763 \\
  \tanh(0.763) &= 0.644 \\
  \mathrm{GELU}(0.921) &= 0.5 \times 0.921 \times (1 + 0.644) \\
...
\begin{align*}
  0.044715 \times (-0.429)^3 &= 0.044715 \times (-0.079) = -0.004 \\
  \sqrt{2/\pi} \times (-0.429 - 0.004) &= 0.7979 \times (-0.433) = -0.346 \\
  \tanh(-0.346) &= -0.333 \\
  \mathrm{GELU}(-0.429) &= 0.5 \times (-0.429) \times (1 - 0.333) \\
