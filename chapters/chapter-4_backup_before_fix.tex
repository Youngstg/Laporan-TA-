...
\hline
\rowcolor{gray!15} \multicolumn{1}{|l|}{\textbf{Parameter}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E1}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E2}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E3}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E4}} \\
\hline
...
\hline
\textit{Epoch} & \multicolumn{4}{r|}{50} \\
\hline
\textit{Batch Size} & \multicolumn{4}{r|}{16} \\
\hline
...
\hline
\rowcolor{gray!15} \multicolumn{1}{|c|}{\cellcolor{gray!15}\textbf{Kode}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textit{\textbf{Backbone}}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textit{\textbf{Pre-train}}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\makecell[c]{\textbf{Rata-rata}\\\textbf{Acc (\%)}}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\makecell[c]{\textbf{\textit{Macro}}\\\textbf{F1 (\%)}}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{MAE}} \\
\hline
...
\hline
\rowcolor{gray!15} \multicolumn{1}{|l|}{\textbf{Parameter}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E5}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E6}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E7}} \\
\hline
...
\begin{tabular}{|l|r|r|r|r|r|r|r|}
\hline
\rowcolor{gray!15} \multicolumn{1}{|c|}{\cellcolor{gray!15}\textbf{Kode}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{Fold 1}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{Fold 2}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{Fold 3}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{Fold 4}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{Fold 5}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\makecell[c]{\textbf{Rata-}\\\textbf{rata}}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{Terbaik}} \\
\hline
...
\begin{tabular}{|l|r|r|r|}
\hline
\rowcolor{gray!15} \multicolumn{1}{|l|}{\textbf{Parameter}} & \makecell[c]{\hspace{0.8cm}\textbf{E8}\hspace{0.8cm}} & \makecell[c]{\hspace{0.8cm}\textbf{E5}\hspace{0.8cm}} & \makecell[c]{\hspace{0.8cm}\textbf{E9}\hspace{0.8cm}} \\
\hline
Strategi Pelatihan & \multicolumn{3}{l|}{\textit{Two-Stage Pre-train}} \\
\hline
Inisialisasi & \multicolumn{3}{l|}{Bobot SSV2} \\
\hline
\textit{Epoch Stage} 1 & \multicolumn{3}{r|}{5} \\
\hline
\textit{Epoch Stage} 2 & 10 & 50 & 100 \\
\hline
\textit{Learning Rate Stage} 1 & \multicolumn{3}{l|}{$10^{-3}$} \\
\hline
\textit{Learning Rate Stage} 2 & \multicolumn{3}{l|}{$10^{-5}$} \\
\hline
\textit{Batch Size} & \multicolumn{3}{r|}{16} \\
\hline
\textit{Hyperparameter} Lain & \multicolumn{3}{c|}{Sama dengan Tabel~\ref{tab:4.umum_config}} \\
...
\hline
\rowcolor{gray!15}\cellcolor{gray!15}\multirow{2}{*}{\textbf{Kelas}} &
  \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E8 (10 epoch)}} &
  \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E5 (50 epoch)}} &
  \multicolumn{3}{c|}{\cellcolor{gray!15}\textbf{E9 (100 epoch)}} \\
\cline{2-10}
...
\begin{tabular}{|l|r|r|}
\hline
\rowcolor{gray!15} \multicolumn{1}{|l|}{\textbf{Parameter}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E5}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E10}} \\
\hline
Strategi \textit{Sampling} & \multicolumn{1}{l|}{\textit{Uniform}} & \multicolumn{1}{l|}{\textit{Dense}} \\
\hline
\textit{Epoch Stage} 1 & \multicolumn{2}{r|}{5} \\
\hline
\textit{Epoch Stage} 2 & \multicolumn{2}{r|}{50} \\
\hline
Jumlah \textit{Frame} & \multicolumn{2}{r|}{16} \\
\hline
\textit{Batch Size} & \multicolumn{2}{r|}{16} \\
\hline
\textit{Learning Rate} & \multicolumn{2}{l|}{$10^{-3}$} \\
\hline
...
\begin{tabular}{|l|r|r|}
\hline
\rowcolor{gray!15} \multicolumn{1}{|l|}{\textbf{Parameter}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E5}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E11}} \\
\hline
\textit{Backbone} & \multicolumn{2}{l|}{ViT-Small} \\
\hline
Dataset \textit{Pre-train} & \multicolumn{2}{l|}{SSV2} \\
\hline
Strategi \textit{Sampling} & \multicolumn{2}{l|}{\textit{Uniform}} \\
\hline
\makecell[l]{Augmentasi\\(\textit{Mixup, CutMix, Reprob})} & \multicolumn{1}{l|}{Aktif} & \multicolumn{1}{l|}{Dinonaktifkan} \\
\hline
\textit{Epoch} (\textit{Stage} 1 / \textit{Stage} 2) & \multicolumn{2}{r|}{5 / 50} \\
\hline
\textit{Batch Size} & \multicolumn{2}{r|}{16} \\
\hline
\textit{Learning Rate} & \multicolumn{2}{l|}{$10^{-3}$} \\
...
\begin{tabular}{|l|r|r|r|r|}
\hline
\rowcolor{gray!15} \multicolumn{1}{|l|}{\textbf{Parameter}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E11}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{E12}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{ViViT}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{I3D}} \\
\hline
...
\hline
\makecell[l]{\textit{Learning}\\Rate} & \multicolumn{4}{l|}{$10^{-3}$} \\
\hline
...
\begin{tabular}{|l|r|r|r|}
\hline
\rowcolor{gray!15} \multicolumn{1}{|c|}{\cellcolor{gray!15}\textbf{Model}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\makecell[c]{\textbf{Library}\\\textbf{Dekode Video}}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{Frame}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{Normalisasi}} \\
\hline
...
\hline
\rowcolor{gray!15} \multicolumn{1}{|c|}{\cellcolor{gray!15}\textbf{Model}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\textbf{Param.}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\makecell[c]{\textbf{Frame}\\\textbf{Input}}} & \multicolumn{1}{c|}{\cellcolor{gray!15}\makecell[c]{\textbf{Rata-rata}\\\textbf{(ms)}}} \\
\hline
